...
<ul>
  ...
  <li><a class="active" href="#">Agregar Alumno</a></li>
...
<div class="container">
  ...
  <br>
	<div class="row">
		...
		<form action="A_agregado.php" method="POST">
		  <br>
          ...
          <br>
          <input type="submit" class= "btn btn-primary btn-block" value="Agregar ALUMNO">
          <br> 
